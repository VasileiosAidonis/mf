   ...
   <div class="container text-center">
     <div id="login">
        ...
        <div class="text-center  my_inputs">
           ...
           <div class="pt-3"><a href="/billings" class="btn btn-primary btn active" role="button" aria-pressed="true">Login</a></div>
           <div class="pt-1"> Ready to join? <a href="/registers/create">Register</a></div>
        </div>
     </div>
   </div>
