...
<div role="img" class="section-background-image"
  ...
  <div class="container bg-light text-dark" style="opacity:93%;">
    <form action="/registers" enctype="multipart/form-data" method="post">
        ...
        <a class="navbar-brand d-flex">
          ...
          <div class="col-5 offset-3">
            <div class="h1 p-1 text-center">Registration</div>
            ...
            <div class="pt-1 text-center" style="padding-bottom:400px;"> Already a Member? <a href="/logins1">Sign in</a></div>
