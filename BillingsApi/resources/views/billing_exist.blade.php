...
<body class="bg-light text-dark">
  ...
  <div class="container" style="background: white; opacity:94%;">
       ...
       <!-- Action to create that will get the username -->
      <form class="pt-1 d-flex" action="/billings/create" enctype="multipart/form-data" method="GET">
        <div class="pr-2 d-flex" style="margin-left:72.3%;">
           <div class="h5 pl-5 pr-2"style=""><button class="btn btn-secondary" style="background-color: black; font-size:85%;"><strong>Catalogue</strong></button></div>
        </div>
